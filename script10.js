...
async function initializeModel() {
    ...
    try {
        classifier = await ml5.imageClassifier('https://teachablemachine.withgoogle.com/models/qWq3-Lprd/', () => {
            isModelLoaded = true;
    ...
    try {
        ...
        if (results.length > 0) {
            ...
            if (presentNames.length > 0) {
                ...
                attendanceHTML += 'Absent: No matching face detected.';
            ...
            attendanceStatus.textContent = 'Absent: No face detected.';
            attendanceStatus.style.color = '#e74c3c';
        }
    } catch (error) {
